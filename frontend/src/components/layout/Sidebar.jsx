...
const Sidebar = ({ onClose }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-purple-800 to-purple-900 text-white">
      {/* Botón cerrar para mobile */}
      {onClose && (
        <div className="flex justify-end p-4 lg:hidden">
          <button
            onClick={onClose}
            className="p-1 rounded-md text-purple-200 hover:text-white hover:bg-purple-700"
          >
      ...
      <div className="px-6 py-4 border-b border-purple-700 bg-purple-800 bg-opacity-50">
      ...
      <div className="px-4 py-2">
        <button
          ...
          className="group flex items-center w-full px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 text-purple-100 hover:bg-red-600 hover:text-white"
        >
          <ArrowRightOnRectangleIcon
            className="flex-shrink-0 h-5 w-5 mr-3"
            aria-hidden="true"
      ...
      <div className="px-6 py-4 border-t border-purple-700">
        <div className="bg-purple-800 bg-opacity-50 rounded-lg p-3">
          <div className="flex items-center">
            ...
            <div className="ml-2">
              <p className="text-xs font-medium text-white">Universidad</p>
              <p className="text-xs text-purple-200">Facultad de Derecho</p>
            </div>
          </div>
        </div>
