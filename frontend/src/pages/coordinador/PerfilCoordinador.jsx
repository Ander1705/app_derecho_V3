...
const PerfilCoordinador = () => {
  ...
  const cargarEstadisticas = async () => {
    try {
      const response = await axios.get('/api/coordinador/estadisticas-perfil')
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Coordinador - Consultorio Jurídico</p>
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="text-sm text-gray-600">Estudiantes Gestionados</span>
                  <span className="font-semibold text-blue-600">{estadisticas.estudiantes_gestionados}</span>
                </div>
                
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="text-sm text-gray-600">Reportes Supervisados</span>
                ...
                {estadisticas.fecha_ingreso && (
                  <div className="py-2">
                    <span className="text-sm text-gray-600 block">Coordinador desde</span>
                    <span className="text-xs text-gray-500">
                      <CalendarIcon className="h-3 w-3 inline mr-1" />
